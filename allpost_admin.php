...
<body>
    ...
    if(isset($_POST['approve'])){
        ...
        $sql="INSERT INTO post (published_at) VALUES('$published_at')";
        $res=mysqli_query($con,$sql) or die (mysqli_error($con));
    }
    
    ?>
    <?php
    $src = "SELECT v.first_name,p.* FROM post p INNER JOIN vlogger v ON p.vlogger_id=v.vlogger_id WHERE  p.status='Approved' or p.status='Rejected'or p.status='Pending' ";
