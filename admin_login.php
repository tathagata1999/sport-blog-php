...
<body style="background-image: url(552031.jpg);background-repeat: no-repeat;background-size:cover;">
    ...
    <div class="bg-secondary">
            ...
            <div  style="float:right; padding-right:8%; padding-top: 3%;">
                <div class="card col shadow" style="border-radius: 3%;" >
                    <h4 class="text-secondery"><b class="text-warning">TOTRON</b>&nbsp;<b style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">ADMIN</b></h4>
                    <div class="card-body " style="height: fit-content;">
                      <div class="card col mr-2 shadow" style="border-radius: 3%;">
                <form name="frm" method="post" action="admin_login_code.php"> 
                    <br>
                    <div class="form-group" style="width:300x;">
                        <label for="a_email"><B class="text-info" style="font-size: large;">EMAIL:</B></label>
                        <input type="a_email" class="form-control border-primary" name="a_email" id="a_email" placeholder="Enter your email">
                    </div>
                    <div class="form-group"  style="width:300px;">
                        <label for="a_pass"><B class="text-info" style="font-size: large;">PASSWORD</B></label>
                        <input type="password" class="form-control border-primary" name="a_pass" id="a_pass" placeholder="Enter your password">
                    </div>
...
<div class="container-fluid " style="background-color: #34282C;padding-top:1.39%;">
