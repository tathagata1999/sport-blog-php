...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary shadow">
        ...
        <div class="collapse navbar-collapse" id="myNavBar">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="admin_post_dataset.php" tabindex="-1">PENDING POSTS</a>
                </li>
                <li class="nav-item ">
    ...
    <?php
    $src = "SELECT v.first_name,p.* FROM post p INNER JOIN vlogger v ON p.vlogger_id=v.vlogger_id WHERE p.status='Approved' ";
    ...
    <?php
        ...
        <div class='alert alert-danger'><strong>NO APPROVED POST FOUND </strong></div></div>";
    }
    ?>
    <br>
    <?php
