...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary shadow">
        ...
        <div class="collapse navbar-collapse" id="myNavBar">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="#" tabindex="-1">PENDING POSTS</a>
                </li>
                <li class="nav-item ">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="rejected_post_show.php" tabindex="-1">REJECTED POSTS</a>
                </li>
                <li class="nav-item ">
    ...
    <?php
    $src = "SELECT v.first_name,p.* FROM post p INNER JOIN vlogger v ON p.vlogger_id=v.vlogger_id WHERE p.status='Pending' ";
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="approve.php?post_id=<?php echo $rec['post_id']?>"><button class="btn btn-success" style="width:88px;" name="approve"  value="approve">APPROVE</button></a>
                        <a href="reject.php?post_id=<?php echo $rec['post_id']?>"><button class="btn btn-danger" style="width:88px;"  value="rejected">REJECTED</button></a></td>
                    </tr>
                <?php
                }
                ?>
